export const SkillData = {
    ...
    // --- 魔法使い（Wizard） ---
    fire:   { id: "fire",   name: "ファイア", menu: "magic", cost: 20, power: 1.5, type: "magic", target: "single", color: "#e67e22", attackTag: "fire" },
    ...
    holy: { id: "holy", name: "ホーリー", menu: "magic", cost: 45, power: 1.9, type: "magic", target: "single", color: "#f7e37a", attackTag: "holy" },
