...
export const SkillData = {
    ...
    encourage: { id: "encourage", name: "鼓舞",   menu: "skill", cost: 15, type: "buff", target: "all",  color: "#e74c3c", desc: "味方全体の攻撃力を高める" },
    whirlwind_slash: { id: "whirlwind_slash", name: "旋風斬り", menu: "skill", cost: 15, power: 1.2, type: "physical", target: "all", color: "#c0392b", attackTag: "slash", desc: "斬属性で全体を攻撃する" },
    flash_strike: { id: "flash_strike", name: "一閃", menu: "skill", cost: 20, power: 2.0, type: "physical", target: "single", color: "#c0392b", attackTag: "slash", desc: "斬属性で単体に対して強攻撃" },
    ...
    // --- 癒し手（Healer） ---
    heal:   { id: "heal",   name: "ケアル",   menu: "magic", cost: 15, power: 1.5, type: "heal", target: "single", color: "#2ecc71", desc: "単体のHPを回復する" },
    medica: { id: "medica", name: "メディカ", menu: "magic", cost: 30, power: 1.2, type: "heal", target: "all",    color: "#2ecc71", desc: "味方全体のHPを回復する" },
    holy_strike: { id: "holy_strike", name: "聖撃", menu: "magic", cost: 18, power: 1.5, type: "magic", target: "single", color: "#f7e37a", attackTag: "holy", desc: "聖属性で単体を攻撃する" },
    holy: { id: "holy", name: "ホーリー", menu: "magic", cost: 25, power: 1.3, type: "magic", target: "all", color: "#f7e37a", attackTag: "holy", desc: "聖属性で全体を攻撃する" },
    prayer: { id: "prayer", name: "いのり",  menu: "main", cost: 0, value: 0.1, duration: 3, type: "regen", target: "all", color: "#8e44ad", desc: "味方全体にリジェネを付与する"},
    raise:  { id: "raise",  name: "レイズ",   menu: "magic", cost: 40, power: 0.5, type: "res",   target: "single", color: "#2ecc71", desc: "戦闘不能の味方を蘇生する" },
